      ...
      <table style={table}>
        ...
        <tr>
          <th style={th}>
            ...
            We're here to help!IF you have any questions or concerns, please don't
            hesitate to reach out to us.
            </p>
            <br/>
            <p className = "text-xs text-gray-500 text-center ">
                Our customer service hours are Monday-Friday,9:00 AM - 5:00 PM EST
            </p>
          </th>
          <th style={th}>
            <p className=" text-xl text-black text-center " >Or use the form below</p>
          </th>
          </tr>
          <tr>
            <td style={th}>
            <tr style={addImg2}> 
                 ...
                 <td style={th}>
                    <h1 className='text-2xl font-semibold p-1'>Reach Us By Phone</h1>
            ...
            <tr style={addImg2}> 
              ...
              <p className='p-1 text-xl'>11086 Auahi St 170, Honolulu, HI 96814, United States</p>
              </td>
            </tr> 
            </td>
            ...
            />
            <br/>
            <label className="block text-md font-medium">Email</label><br/>
            <input
              type= "email"
              className="mt-1 p-2 border w-full"   
            /> 
            <br/>
            <label className="block text-md font-medium">Phone Number</label><br/>
            <input
              type= "text"
              className="mt-1 p-2 border w-full"
            /> 
            <br/>
            <label className="block text-md font-medium">Subject</label><br/>
            <input
              type= "text"
              className="mt-1 p-2 border w-full"
            /> 
            <br/>
            <label className="block text-md font-medium">Message</label><br/>
            <textarea
              type= "text"
            ...
            <button className="mt-1 p-2 w-full border bg-amber-500 text-white  font-bold">Submit Now</button>   
